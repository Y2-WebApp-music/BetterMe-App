...
const CommunityGoalCard = ({goal_id, goal_name, total_task, complete_task}:calendarGoalCardProp) => {
  ...
  return (
    <TouchableOpacity  onPress={()=>{router.push(`/community/user/goal/${goal_id}`)}} style={{marginBottom: 8}} className='h-32 w-full bg-white rounded-normal border border-gray justify-center items-center'>
