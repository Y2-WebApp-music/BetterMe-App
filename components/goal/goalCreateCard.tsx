...
const GoalCreateCard = ({goal_id, goal_name, start_date, end_date, total_task, create_by}:GoalCreateCardProp) => {
  ...
  return (
    <TouchableOpacity style={{marginBottom: 8, backgroundColor:colors.background,borderColor:colors.gray}} className='h-32 p-4 w-full justify-center rounded-normal border border-gray bg-white flex-row'>
